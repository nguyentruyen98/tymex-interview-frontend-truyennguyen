...
const Footer = () => {
  return (
    <div className="bg-secondary grid grid-cols-1 grid-rows-3 gap-10 px-8 py-6 pb-20 lg:grid-cols-2 lg:grid-rows-2 lg:px-16 lg:py-10 lg:pb-40 xl:grid-cols-3 xl:grid-rows-1 xl:py-15 xl:pb-52">
